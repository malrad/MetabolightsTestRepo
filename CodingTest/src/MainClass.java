...
class Test{
	...
	public void machineCount() {	
		...
		List<Process> processList = createProcessList(processStrList); //[startTime: 0 endTime: 3, startTime: 15 endTime: 18, startTime: 17 endTime: 20, startTime: 2 endTime: 10]
...
class Machine implements Comparable<Machine>{
	...
	public int compareTo(Machine arg) {
		return Integer.compare(this.processList.get(this.processList.size()-1).endTime, arg.processList.get(arg.processList.size()-1).endTime);
	}
	// A 0,3 5,6 10,15
	// B 0,2 16,18
}
